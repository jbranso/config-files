...
<x-color><param>#D0BF8F</param>**** </x-color><x-color><param>#CC9393</param>TODO</x-color><x-color><param>#D0BF8F</param> German interview for extra credit in SC 244</x-color>

     SCHEDULED: <x-color><param>#8CD0D3</param><<2014-11-07 Fri 14:30></x-color>
...
<x-color><param>#D0BF8F</param>**** </x-color><x-color><param>#AFD8AF</param>DONE</x-color><x-color><param>#D0BF8F</param> Order cap and gown through Graduation Tab.</x-color>
     CLOSED: <x-color><param>#8CD0D3</param>[2014-11-04 Tue 11:13]</x-color> SCHEDULED: <x-color><param>#8CD0D3</param><<2014-11-03 Mon></x-color>
...
<x-color><param>#BFEBBF</param>** Job Search								</x-color><x-color><param>#BFEBBF</param>:job:</x-color>
...
<x-color><param>#7CB8BB</param>*** </x-color><x-color><param>#AFD8AF</param>DONE</x-color><x-color><param>#7CB8BB</param> Research Manifest Solutions in Columbus Ohio and that job in Indy on your voicemail.</x-color>
    CLOSED: <x-color><param>#8CD0D3</param>[2014-11-04 Tue 11:22]</x-color> SCHEDULED: <x-color><param>#8CD0D3</param><<2014-11-04 Tue 11:30></x-color>
...
<x-color><param>#D0BF8F</param>**** </x-color><x-color><param>#CC9393</param>TODO</x-color><x-color><param>#D0BF8F</param> See if anyone is the Hack Duke Facebook group responded about my post and want to car pool.</x-color>
...
<x-color><param>#7CB8BB</param>*** </x-color><x-color><param>#CC9393</param>TODO</x-color><x-color><param>#7CB8BB</param> Wild Hacks Northwestern University at noon? Sunday 1pm.</x-color>

    SCHEDULED: <x-color><param>#8CD0D3</param><<2014-11-22 Sat></x-color>
<x-color><param>#D0BF8F</param>**** </x-color><x-color><param>#AFD8AF</param>DONE</x-color><x-color><param>#D0BF8F</param> look up shuttle info for getting to wild hacks</x-color>
     CLOSED: <x-color><param>#8CD0D3</param>[2014-11-04 Tue 11:47]</x-color> SCHEDULED: <x-color><param>#8CD0D3</param><<2014-11-04 Tue 11:30></x-color>
