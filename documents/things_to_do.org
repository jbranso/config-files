...
<x-color><param>#7CB8BB</param>*** meet up with Sacha Chua and learn cool things to do with emacs!!!!</x-color>
...
<x-color><param>#7CB8BB</param>*** (setq adaptive-fill-regexp REGEXP)</x-color>
...
<x-color><param>#7CB8BB</param>*** emulate these vim commands</x-color>
<x-color><param>#D0BF8F</param>**** d{motion} d</x-color>

     delete everything from point to where motion takes you.
<x-color><param>#D0BF8F</param>**** make d ace-jump-char cut where ace jump takes you.</x-color>
<x-color><param>#D0BF8F</param>**** make c act-jump-char copy where ace jump takes you.</x-color>

<x-color><param>#7CB8BB</param>*** load any changes in emacs with after-init-hook, that way your init file doesn't break. It'll be a way</x-color>
